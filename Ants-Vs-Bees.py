...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        while position and not position.is_hive:
          if self.lower_bound <= distance <= self.upper_bound and position.bees:
...
class FireAnt(Ant):
    ...
    def reduce_health(self, amount):
        ...
        if self.health - amount <= 0:
          reflective_damage += self.damage  #adds the amount of health to the damage
...
class HungryAnt(Ant):
  ...
  #       while position:
  #         if  position.bees:
  #           return random.choice(position.bees)
...
# END Problem 12
    ...
    def construct(cls, gamestate):
        ...
        """
        # BEGIN Problem 12
        if not gamestate.queen_position:
          gamestate.queen_position = True
        ...
        while curr_place:
          ...
          if ant:
            ...
            if ant.is_container and ant.ant_contained:
              #handle the case when an ant is contaiied in a container ant
    ...
    def reduce_health(self, amount):
        ...
        # END Problem 12
    def remove_from(self,place):
      pass #do nothing, will override inhertied "remove_from" method
...
class NinjaAnt(Ant):
    ...
    def action(self, gamestate):
        ...
        bees_copy = self.place.bees[:]
        for bee in bees_copy:
            self.place.bee.reduce_health(self.damage)
